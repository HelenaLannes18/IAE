                        ...
                        <div className="sticky top-32 flex flex-row md:flex-col gap-8 md:gap-10 border-t md:border-t-0 pt-8 md:pt-0 border-slate-200">
                            ...
                            <div>
                                ...
                                <div className="space-y-5">
                                    {(article.authors && article.authors.length > 0 ? article.authors : [{ id: 0, name: 'Administrador', imageUrl: null, bio: null }]).map((author: any) => (
                                        <div key={author.id} className="flex items-start gap-3">
                                            <img
                                                ...
                                                alt={author.name}
                                                title={author.name}
                                                className="w-10 h-10 rounded-full border-2 border-[#f5f4f0] object-cover shadow-sm shrink-0"
                                            />
                                            <div>
                                                <p className="font-bold text-slate-900 text-sm leading-tight">{author.name}</p>
                                                {author.bio && (
                                                    <p className="text-slate-500 text-xs leading-relaxed mt-1">{author.bio}</p>
                                                )}
                                            </div>
                                        </div>
                                    ))}
