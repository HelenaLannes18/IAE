...
const RELATED_ARTICLES = [
    ...
    },
    {
        ...
        title: "Como planejar o próximo trimestre",
        category: "Strategy",
        readTime: "7 min",
    ...
    },
    {
        ...
        title: "Maximizando lucros no mercado atual",
        category: "Insights",
        readTime: "5 min",
    ...
    },
    {
        ...
        title: "Venture Capital: O que buscam?",
        category: "Funding",
        readTime: "8 min",
    ...
    },
    {
        ...
        title: "Adaptabilidade no setor de tecnologia",
        category: "Strategy",
        readTime: "4 min",
...
export default function BlogPostPage() {
    ...
    const filteredArticles = RELATED_ARTICLES.filter((post) => {
        const matchesSearch =
    ...
    const pinnedArticles = filteredArticles.filter(post => post.isPinned);
    const commonArticles = filteredArticles.filter(post => !post.isPinned);
    ...
    return (
        <div className="min-h-screen bg-[#f5f4f0] text-slate-900 font-sans selection:bg-amber-200">
            ...
            <main className="pt-32 pb-20 overflow-hidden">
                ...
                {/* IMAGEM PRINCIPAL TIPO FAIXA ("FILETINHO") */}
                <motion.div
                ...
                <div className="max-w-4xl mx-auto px-4 grid grid-cols-1 md:grid-cols-12 gap-10">
                    ...
                    >
                        <div className="space-y-8 text-slate-700 text-lg leading-[1.8] tracking-wide">
                ...
                {/* NOVA PROPAGANDA DO CURSO (Estilo Banner Escuro - Inspirado na Referência) */}
                <motion.div
                ...
                >
                    <div className="relative bg-[#0a0a0a] text-white overflow-hidden py-16 md:py-20 px-8 md:px-12 flex flex-col md:flex-row items-center justify-between gap-10 shadow-2xl rounded-sm">
                        {/* Fundo com textura sutil em preto e branco para simular a imagem */}
...
// Sub-componente do Carrossel Arrastável (Reutilizável)
